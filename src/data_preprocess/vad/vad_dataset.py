...
def get_train_data(
    ...
    data_dir = str(Path(__file__).parent.parent.parent.parent) + "/data/pc_single_ch"
    label_dir = (
        str(Path(__file__).parent.parent.parent.parent) + "/data/pc_single_ch/segment"
    )
    ...
    data_dir = str(Path(__file__).parent.parent.parent.parent) + "/data/board"
    label_dir = str(Path(__file__).parent.parent.parent.parent) + "/data/board/segment"
